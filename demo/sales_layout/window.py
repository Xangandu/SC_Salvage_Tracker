"""Demo-Fenster zum Vergleich der Verkaufs-Layouts."""
...
from demo.sales_layout.layouts import LAYOUT_VARIANTS
from ui.page_layout import hud_divider


class SalesLayoutDemoWindow(QMainWindow):

    def __init__(self):
        super().__init__()
        self.setObjectName("mainWindow")
        self.setWindowTitle("SC Salvage Tracker — Verkäufe Layout DEMO")
        ...
        banner_title = QLabel("DEMO — Verkäufe übersichtlicher aufteilen")
        banner_title.setObjectName("warningBannerTitle")
        banner_hint = QLabel(
            "Keine echten Daten. Oben die Variante wählen und vergleichen. "
            "Variante B nutzt die Breite ähnlich wie die Auszahlungsseite."
        )
