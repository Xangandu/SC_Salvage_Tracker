...
class SuperAdminRecoveryDialog(MobiglasFramelessMixin, QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Notfall-Wartung")
        self.setModal(True)
        self.resize(580, 560)
        ...
        self.action_button = primary_button("Weiter")
        ...
        layout.addWidget(page_title("NOTFALL-WARTUNG"))
    ...
    def _build_menu_page(self):
        ...
        panel_layout.addWidget(subsection_title("Optionen"))

        admin_count = self.db.count_org_administrators()
        status = QLabel(
            f"Aktive Organisations-Administratoren: {admin_count}\n\n"
        ...
        reset_button = QPushButton("Benutzer-Passwort zurücksetzen")
    ...
    def _build_create_admin_page(self):
        ...
        panel_layout.addWidget(
            subsection_title("Administrator anlegen")
        )
    ...
    def _build_reset_password_page(self):
        ...
        panel_layout.addWidget(
            subsection_title("Passwort zurücksetzen")
        )
    ...
    def _open_create_admin(self):
        ...
        self.action_button.setText("Administrator anlegen")
    ...
    def _open_reset_password(self):
        ...
        self.back_button.setVisible(True)
        self.action_button.setVisible(True)
        self.action_button.setText("Passwort zurücksetzen")
    ...
    def _create_administrator(self):
        ...
        if role_id is None:
            QMessageBox.critical(
                self,
                "Notfall-Wartung",
                f"Die Rolle „{ROLE_ADMIN}“ wurde nicht gefunden.",
            )
            return
        ...
        try:
            ...
            QMessageBox.warning(self, "Notfall-Wartung", str(error))
            return
        except Exception:
            QMessageBox.warning(
                self,
        ...
        QMessageBox.information(
            self,
            "Notfall-Wartung",
            f"Der Administrator „{username}“ wurde angelegt.\n\n"
    ...
    def _reset_password(self):
        ...
        QMessageBox.information(
            self,
            "Notfall-Wartung",
            f"Das Passwort für „{username}“ wurde zurückgesetzt.\n\n"
